...
export function Toolbar() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1.5 px-3 py-2 bg-zinc-900/90 dark:bg-zinc-950/90 backdrop-blur-xl border border-white/10 dark:border-white/5 rounded-2xl shadow-[0_12px_40px_-12px_rgba(0,0,0,0.5)]">
      {tools.map((t) => {
